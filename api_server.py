...
<body>
  ...
  <div class="row">
    <section>
      ...
      <input id="agentName" placeholder="AnalystAgent"/>
      ...
      <input id="modelName" placeholder="Qwen2.5-3B-Instruct"/>

      <input id="agentTags" placeholder="analysis, summary"/>

      <textarea id="agentPrompt" rows="4" placeholder="Ты аналитический агент..."></textarea>
    ...
    <section>
      ...
      <input id="runAgentName" placeholder="AnalystAgent"/>

      <textarea id="runPrompt" rows="4" placeholder="Объясни архитектуру проекта"></textarea>
  ...
  <textarea id="handlerRequest" rows="4" placeholder="Создай агента AnalystAgent на модели Qwen2.5-3B-Instruct..."></textarea>
